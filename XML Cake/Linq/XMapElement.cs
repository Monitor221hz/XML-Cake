...
public class XMapElement : XElement, IXMap
{
	...
	public XMapElement(XElement document, Func<XElement, string> generateKey) : base(document)
	{
		GenerateKey = generateKey;
		MapElementToPath = MapNormal;
	}

	public XMapElement(XElement document) : base(document)
	{
	...
	/// <param name="path"></param>
	/// <returns></returns>
	public XElement NavigateTo(string path) => NavigateTo(path, this);
